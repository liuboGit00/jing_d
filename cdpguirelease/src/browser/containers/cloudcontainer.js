...
import {fetch_clouds,echo_create_connection_modal,close_create_connection_modal,echo_create_vpc_modal,
    ...
    set_vpc_switch_on,set_vpc_switch_off,
            ...
            return (
                <Row>
                    ...
                    <Row className="table_toolbar">
                        <Button type='ghost' className="cdp_button_left" icon='link' onClick={this.handle_create_connection}>创建连接配置</Button>
                    ...
                    <CreateVPC ref='createvpc' clouds={clouds} clones={clones.items} visible={clouds.create_vpc_modal} onOk={this.submit_create_vpc} dispatch={dispatch}
                        onCancel={this.handle_close_vpc} volumes={volumes}/>
                </Row>
            );
        }
    }
