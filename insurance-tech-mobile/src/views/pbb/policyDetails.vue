<template>
  <div class="content_wrap">
    <div class="inner_wrap">
      ...
      <div :class="policyData.policyStatusName=='已失效'?'policy_wrap':''">
        <div class="info_wrap">
        ...
        <div class="info_wrap">
          ...
          <span class="stamp" :class="computerStatus(policyData.policyStatus)"></span>
        </div>
      </div>
    </div>
      
    <div class="text_wrap">
      <p>查看<a href="保险条款.pdf" target="_black">《保险条款》</a></p>
      <p>本产品由光大永明人寿保险有限公司提供，<span v-if="policyData.policyStatus===3 || policyData.policyStatus===-11 || policyData.policyStatus===-12 || policyData.policyStatus===-21 || policyData.policyStatus===-22"><a :href="baseUrl" download="文件名.txt" class="undeline_a">点击此处</a>下载个人电子凭证，</span>理赔、咨询及其他问题请致电客服热线95348.</p>
    </div>
    <div class="btn_area" v-if="policyData.policyStatusName=='已失效'">
      <router-link to="/insure"></router-link>
      <a class="weui_btn btn_primary" href="javascript:" id="" @click="completeBtn">重启保障</a>
    </div>
  </div>
</template>
<script>
  ...
  methods: {
      policyListData() {
          ...
          PEIBANBAOINTERFACE.policyQueryStaff({
              ...
              that.baseUrl = `${base.sq}/policy/download/${res.data.data.voucherNo}`
              that.$toast("", 2, 500)
          })
      },
      completeBtn() {
...
.content_wrap {
  ...
  .info_wrap {
    ...
    .stamp {
      ...
      .bg-images-inline('gmrs.png');
      position: absolute;
      top: .4rem;
      right: 0;
      &.code_bzz {
        .bg-images-inline('gdrs_r.png');
      }
    }
    &:last-child {
      border-bottom: none;
